...
def retweetsByDate(retweetsDF,days,volumesDF):
    ...
    tweetsDF = pd.read_csv('gme-tweets-emotion.csv',dtype={'id': str, 'author.id':str}) ##
...
if __name__ == '__main__':
    ...
    retweetsDF = pd.read_csv('gme-rts-01-07.csv',dtype=str) ##
    
    volumesDF = pd.read_csv('GME.csv') ##
