...
def retweetsByDate(retweetsDF,days,volumesDF):
    ...
    tweetsDF = pd.read_csv('amd-tweets-emotion.csv',dtype={'id': str, 'author.id':str}) ##
    ...
    for day in days:
        ...
        nx.readwrite.write_edgelist(digraphTCC,'AMD'+str(flag)+'edgelist.csv',delimiter=',',data=['weight'])
...
if __name__ == '__main__':
    ...
    retweetsDF = pd.read_csv('amd-rts-01-07.csv',dtype=str) ##
    
    volumesDF = pd.read_csv('AMD.csv') ##
